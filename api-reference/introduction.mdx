---
title: 'Introduction'
description: 'Securely manage user identities and authentication with the Identity API.'
---
...
This documentation is intended for developers who want to integrate the Identity API into their applications. It assumes familiarity with HTTP, REST, and basic authentication concepts.
